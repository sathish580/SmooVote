...
document.getElementById("test-clock").appendChild(el);

// document.body.appendChild(el);
// var card_array = document.getElementsByClassName("card-text");

// for(onecard of card_array){
//   // onecard.appendChild(el);
//   console.log("hello i am in the card")
//   console.log(onecard)
// }
